...
class GameObjectManager: IGameObjectManager
{
    ...
    {
        GameObject imageObj = GameObject.Find(isUpSideImage ? Constants.GameObjectNames.UP_SIDE_IMAGE_OBJECT_NAME : Constants.GameObjectNames.DOWN_SIDE_IMAGE_OBJECT_NAME);
        if (imageObj == null)
        {
    ...
    {
        return obj.name == Constants.GameObjectNames.UP_SIDE_IMAGE_OBJECT_NAME || obj.name == Constants.GameObjectNames.DOWN_SIDE_IMAGE_OBJECT_NAME;
    }
